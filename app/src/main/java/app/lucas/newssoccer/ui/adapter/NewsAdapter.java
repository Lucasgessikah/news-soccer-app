package app.lucas.newssoccer.ui.adapter;
...
import app.lucas.newssoccer.R;
import app.lucas.newssoccer.databinding.NewsItemBinding;
...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // Implementação da funcionalidade de "Favorite" (O evento será instanciado pelo fragment)
